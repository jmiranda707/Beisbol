...
class _FinPageState extends State<FinPage> {
  ...
  playLocal() async {
    ...
    await player.play('audios/venevision.mp3',);
  }
  ...
  Equipo ganador= (equipo2.carreras > equipo1.carreras)? equipo2: equipo1;
      ...
      child: CircleAvatar(
        ...
        child: Stack(
            children: [
              Image(
              fit: BoxFit.contain,
              image: AssetImage("assets/logosEquipos/${ganador.logoImage}"),
            ),
  ...
  child: DefaultTextStyle(
    ...
    child: AnimatedTextKit(
      ...
      repeatForever: true,
      animatedTexts: [
        TyperAnimatedText('Felicidades al equipo...',textStyle: TextStyle(
      fontSize: 80,
      fontFamily: 'Bobbers',
    ...
    speed: Duration(milliseconds: 70)
        ...
        TyperAnimatedText('CAMPEÓN...',textStyle: TextStyle(
      fontSize: 80,
      fontFamily: 'Bobbers',
    ),
     textAlign: TextAlign.center,
    speed: Duration(milliseconds: 70)),
        TyperAnimatedText('${ganador.nombre.toUpperCase()}!!!',textStyle: TextStyle(
      fontSize: 80,
      fontFamily: 'Bobbers',
    ),
     textAlign: TextAlign.center,
