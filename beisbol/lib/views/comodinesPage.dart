      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            padding: EdgeInsets.symmetric(vertical: w(10), horizontal: w(60)),
            color: Colorz.negro.withOpacity(0.75),
            child: SingleChildScrollView(
                          child: Column(
                children: [
                  SizedBox(height: w(30)),
                  _comodinIcono('equipo.jpg', 'Permite al bateador en turno, consultar con todo el equipo, la pregunta.', 'Consultar Equipo'),
                 SizedBox(height: w(15)),
                  _comodinIcono('biblia.jpg', 'Permite al bateador abrir su biblia, para consultar la pregunta.', 'Consultar Biblia'),
                  SizedBox(height: w(15)),
                  ...
                  SizedBox(height: w(15)),
                  _comodinIcono('cambiar.jpg', 'Elimina la pregunta actual, y se picha una nueva pregunta al bateador en turno.', 'Otra Pregunta'),
                 SizedBox(height: w(15)),
                  _comodinIcono('bateador.jpg', 'El manager tiene la opción de cambiar al bateador actual por cualquier otro jugador del equipo, excepto el manager mismo. NOTA: esto afecta el orden de todos los bateadores.', 'Bateador Emergente'),
                  CircularButton(
